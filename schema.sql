...
CREATE TABLE communities (id SERIAL PRIMARY KEY, name TEXT);
...
CREATE TABLE threads_to_users(user_id INT NOT NULL, thread_id INT NOT NULL, seen BOOLEAN DEFAULT FALSE, vote INT NOT NULL)
CREATE TABLE threads_to_users (user_id INT NOT NULL, message_id INT NOT NULL, vote INT NOT NULL)
